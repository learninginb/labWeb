...
<script type="text/javascript">
	...
	function toSubmit(){
		...
		//表单提交
		$("#add_form").ajaxSubmit({
			url:"${"${"}path}/${table.controllerName?uncap_first}/add.do",
		...
		<div class="formbody">
   			...
   			<form id="add_form" method="post">
				<ul class="forminfo">
					...
					<li><label>${u.columnComment}：</label><input name="${u.javaFullName}" id="${u.javaFullName}" type="text" class="wdateExt input-primary Wdate" style="width:350px" onFocus="WdatePicker({isShowClear:false})"  /></li>
						<#else>  
					<li><label>${u.columnComment}：</label><input name="${u.javaFullName}" id="${u.javaFullName}" type="text" class="form-control input-primary" style="width:350px" /></li>
					    </#if>
					    </#if>
					</#list>
