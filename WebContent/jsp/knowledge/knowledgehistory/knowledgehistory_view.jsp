...
<script type="text/javascript">
	$(function() {
		...
		val = $("#createUser").val();
		$.ajax({
			url:"${path}/sysUserController/findJsonById.do",
			data:{id:val},
			dataType : 'JSON',
			type : 'post',
			success:function(data) {
				console.info(data.obj)
				$("#createUser").val(data.obj.userName);
			}
		});
	...
	<div>
		...
		<div class="formbody">
   			...
   			<form id="add_form" method="post">
				...
				<ul class="forminfo">
					<li><label>版本号：</label><input name="knowledgeVersion" id="knowledgeVersion" value="${vo.knowledgeVersion}" type="text" class="form-control input-primary" disabled="disabled" style="cursor: not-allowed;width:350px"  /></li>
					<li><label>信息分类：</label>
