...
<script type="text/javascript">
	...
	function toSubmit(){
		...
		//表单提交
		$("#add_form").ajaxSubmit({
			url:"${path}/knowledgeReadingController/add.do",
		...
		<div class="formbody">
   			...
   			<form id="add_form" method="post">
				<ul class="forminfo">
					...
					<li><label>用户id：</label><input name="userId" id="userId" type="text" class="form-control input-primary" style="width:350px" /></li>
					<li><label>阅读时间：</label><input name="readTime" id="readTime" type="text" class="wdateExt input-primary Wdate" style="width:350px" onFocus="WdatePicker({isShowClear:false})"  /></li>
