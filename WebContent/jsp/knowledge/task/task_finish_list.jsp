...
function viewById(id){
	var task = $('#FinishTaskList').bootstrapTable('getRowByUniqueId', id);
...
//查询列表
function queryList() {
	$('#FinishTaskList').bootstrapTable('refresh');
}
...
<body>
    ...
    <div class="rightinfo">
    	...
    	<table id="FinishTaskList" data-toggle="table"
			data-url="${path}/TaskController/finishList.do" data-pagination="true"
